...
func (m *MockRestClient) Post(ctx context.Context, endpoint string, body any, headers map[string]string) (*resty.Response, error) {
	args := m.Called(ctx, endpoint, body, headers)
	resp, _ := args.Get(0).(*resty.Response)
	return resp, args.Error(1)
}

func (m *MockRestClient) Put(ctx context.Context, endpoint string, body any, headers map[string]string) (*resty.Response, error) {
	args := m.Called(ctx, endpoint, body, headers)
	resp, _ := args.Get(0).(*resty.Response)
	return resp, args.Error(1)
}

func (m *MockRestClient) Patch(ctx context.Context, endpoint string, body any, headers map[string]string) (*resty.Response, error) {
	args := m.Called(ctx, endpoint, body, headers)
	resp, _ := args.Get(0).(*resty.Response)
	return resp, args.Error(1)
}
